...
import com.xiaopeng.bean.LoginUser;
...
public class LoginFailDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 7.打印
        cep.select(new PatternSelectFunction<LoginUser, List<LoginUser>>() {
            @Override
            public List<LoginUser> select(Map<String, List<LoginUser>> pattern) throws Exception {
