...
public class SseAvro extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public SseAvro(CharSequence mdStreamID, CharSequence securityID, CharSequence symbol, Long tradeVolume, Long totalValueTraded, Double preClosePx, Double openPrice, Double highPrice, Double lowPrice, Double tradePrice, Double closePx, CharSequence tradingPhaseCode, Long timestamp) {
  ...
  /**
   * Creates a new SseAvro RecordBuilder.
   * @return A new SseAvro RecordBuilder
   */
  ...
  /**
   * Creates a new SseAvro RecordBuilder by copying an existing Builder.
  ...
  /**
   * Creates a new SseAvro RecordBuilder by copying an existing SseAvro instance.
   * @param other The existing instance to copy.
   * @return A new SseAvro RecordBuilder
   */
  public static Builder newBuilder(SseAvro other) {
    return new Builder(other);
  }

  /**
   * RecordBuilder for SseAvro instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SseAvro>
    implements org.apache.avro.data.RecordBuilder<SseAvro> {
    ...
    /**
     * Creates a Builder by copying an existing SseAvro instance
     * @param other The existing instance to copy.
     */
    private Builder(SseAvro other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.mdStreamID)) {
        this.mdStreamID = data().deepCopy(fields()[0].schema(), other.mdStreamID);
        fieldSetFlags()[0] = true;
    ...
    @Override
    public SseAvro build() {
      try {
        SseAvro record = new SseAvro();
